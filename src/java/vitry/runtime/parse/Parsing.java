...
public class Parsing
{
    ...
    public static final int EQ       = findToken("=");
    ...
    public static final int INFIX    = findToken("infix");
    ...
    private static int findToken(String t)
    {
        ...
        if (res < 0)
            throw new AssertionError("Token type of " + t + "is < 0");
        return res;
    }
