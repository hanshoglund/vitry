...
---------------
  ...
  Usage:
    beautify(js_source_text);
    beautify(js_source_text, options);
  ...
  The options are:
    ...
    beautify(js_source_text, {indent_size: 1, indent_char: '\t'});

 */



exports.beautify = function (js_source_text, options) {
